...
<table width="800" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="398" align="left" valign="middle">
        <input type="hidden" name="st" value="tambah"/> <input type="text" name="judul" class="input-teks" size="80" />    </td>
  </tr>
  <tr>
    <td height="33" align="left" valign="middle">Link Artikel </td>
    <td align="center" valign="middle">:</td>
    <td align="left" valign="middle">
        <input type="text" name="link_ar" class="input-teks" size="80" /></td>
  </tr>
  <tr>
    <td height="33" align="left" valign="middle">Link Download </td>
    <td align="center" valign="middle">:</td>
    <td align="left" valign="middle">
        <input type="text" name="link_dl" class="input-teks" size="80" /></td>
  </tr>
  <tr>
